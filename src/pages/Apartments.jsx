...
const Apartments = () => {
  ...
  return (
    <div className="App">
      ...
      <div style={{ padding: '1rem', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {filteredProperties.length === 0 && (
          <div style={{ textAlign: 'center', padding: '3rem 1rem' }}>
            ...
            <h3 style={{ fontSize: '1.125rem', fontWeight: '600', color: 'var(--text-primary)', marginBottom: '0.5rem' }}>No apartments found</h3>
      ...
      {/* Sidebar */}
              <Sidebar isOpen={showSidebar} onClose={() => setShowSidebar(false)} userRole="admin" />
    </div>
  );
};
